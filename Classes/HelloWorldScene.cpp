...
{
	cocos2d::log("from cocos2d::log output--->show dragonbone demo");

	//ref link:https://www.litefeel.com/blog/how-to-do-lua-bindings-for-dragonbones-vs/

	const auto& stageSize = cocos2d::Director::getInstance()->getVisibleSize();
	const auto factory = dragonBones::CCFactory::getFactory();
	factory->loadTextureAtlasData("assets/dragon_boy_tex.json");
